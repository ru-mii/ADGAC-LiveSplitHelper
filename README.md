...
This mod is created to work with [BepInEx](https://github.com/BepInEx/BepInEx), you would unzip the .zip file from [Releases](https://github.com/ru-mii/ADGAC-LiveSplitHelper/releases) and then copy paste into your plugins folder in BepInEx, should like like this...
